# Inheritance
Project done during **Full Stack Software Engineering studies** at **ALX One Year Software Engineering Program**. It aims to learn about inheritance, superclass, baseclass and subclass in **Python**.
